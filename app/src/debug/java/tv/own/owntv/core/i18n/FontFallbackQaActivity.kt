        ...
        setContent {
            HanTVTheme(
                ...
                Column(
                    ...
                    QaSection("Normal HanTV typography")
...
private fun QaSection(heading: String) {
    Column(
        ...
        Text("Malayalam — മലയാളം: HanTV-ലേക്ക് സ്വാഗതം")
        Text("Hindi — हिन्दी: HanTV में आपका स्वागत है")
        Text("Bangla — বাংলা: HanTV-তে স্বাগতম")
        Text("Cyrillic — Русский: Сейчас в эфире")
        Text("Greek — Ελληνικά: Τώρα παίζει")
        Text("Mixed Latin/Arabic — HanTV • الحلقة 12 • HD")
        Text("Mixed Latin/CJK — HanTV • 第12話 • 4K")
