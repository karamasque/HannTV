...
private fun menuIcon(menu: ContentMenu) = when (menu) {
    ContentMenu.LIVE -> HanTVIcon.LIVE_TV
    ContentMenu.MOVIE -> HanTVIcon.MOVIES
    ContentMenu.SERIES -> HanTVIcon.SERIES
    ContentMenu.EPISODE -> HanTVIcon.LIST_GRID
}
...
private fun ArrangeMenuOverlay(
    ...
    HanTVPopup(onDismissRequest = onCancel) {
            ...
            Box(
                ...
                Column(
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
                        HanTVButton(stringResource(R.string.common_save), onClick = { onSave(keys) }, modifier = Modifier.weight(1f))
                        HanTVButton(stringResource(R.string.common_cancel), onClick = onCancel, style = HanTVButtonStyle.SECONDARY, modifier = Modifier.weight(1f))
                    }
                }
            }
        }
