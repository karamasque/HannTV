...
fun WeatherSettingsScreen(onBack: () -> Unit, modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Row2(
            icon = HanTVIcon.WEATHER, title = stringResource(R.string.settings_show_weather),
        ...
        Row2(
            icon = HanTVIcon.WEATHER, title = stringResource(R.string.settings_custom_location),
        ...
        Row2(
            icon = HanTVIcon.WEATHER, title = stringResource(R.string.settings_temperature_unit),
