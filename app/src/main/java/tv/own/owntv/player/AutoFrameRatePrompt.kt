 ...
 * limitation of the direct path, not something HanTV can smooth over, and **Auto frame rate is the only
    ...
    Box(
        ...
        Column(Modifier.dialogPanel(width = 520.dp, padding = 28.dp)) {
            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                HanTVButton(stringResource(R.string.player_frame_rate_turn_on), onClick = onEnable, modifier = Modifier.focusRequester(focus))
            }
        }
    }
    }
