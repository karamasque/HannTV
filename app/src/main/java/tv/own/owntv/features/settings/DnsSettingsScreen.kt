        ...
        if (toggleOn) {
            Column {
                ...
                Row(
                    ...
                    for ((label, url) in DohPresets.all) {
                        ...
                        HanTVButton(
                            ...
                            style = if (isActive) HanTVButtonStyle.PRIMARY else HanTVButtonStyle.SECONDARY,
                            modifier = if (first) {
                                first = false
                ...
                Row(
                    ...
                    HanTVButton(stringResource(R.string.common_save), onClick = { applySave() }, modifier = Modifier.focusRequester(saveFocus))
                    HanTVButton(
