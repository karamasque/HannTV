<p align="center">
  <img src="logo.png" alt="HanTV" width="300">
</p>

<h1 align="center">HanTV — Master Product Brief</h1>
...
HanTV is a native **Android TV** IPTV player written in Kotlin with Jetpack Compose for TV, running
...
A companion **[HanTV Mobile](https://github.com/ahXN00/HanTV_Mobile)** app for phones and tablets
...
Most providers never publish how many streams an account may run, so HanTV **measures it once**, at a
...
disclaimer → **Set up HanTV** → profile → **add a playlist** → how to enter it → the import, closing
with an offer to download the guide. **Set up HanTV** offers three routes, not two: create a profile,
restore a backup file, or **copy everything from another HanTV device** over the local network — so
...
**Local sync** swaps favourites, history and resume positions with the HanTV mobile app over the
...
| Repo | Holds |
|---|---|
| **[HanTV_Core](https://github.com/ahXN00/HanTV_Core)** | Database, sync, parsers, EPG, backup, profiles, downloads, recording, settings storage, both playback engines, **and every translated string** |
| **[HanTV](https://github.com/ahXN00/HanTV)** | This app — Compose-for-TV interface, navigation, player HUD |
| **[HanTV_Mobile](https://github.com/ahXN00/HanTV_Mobile)** | The phone and tablet interface |
