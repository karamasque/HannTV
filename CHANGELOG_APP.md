...
- **🚀 Yerel Derleme & İmzalı Release:** Sürüm 2.1.0 yerel imzalı APK yayını
- **🎨 Görünüm ve Tema:** Arayüz temaları doğrudan Ayarlar > Görünüm menüsüne entegre edildi
- **⚡ Otomatik IPTV Düzeltmesi:** Otomatik IPTV sekme adı ve 2 kartlı seçim düzeni tamamlandı

## v2.0.9

### ✨ New features

- **🎨 Görünüm ve Tema Ayarları:** Ayarlar menüsüne Arayüz Teması doğrudan erişilebilir olarak eklendi
- **⚡ Kaynak Ekleme İyileştirmesi:** Otomatik IPTV sekme adı düzeltildi ve kaynak seçim ekranı sadeleştirildi
- **🔒 Keystore İmzası:** Otomatik güncellemeler için dijital imza eşitlemesi yapıldı
...
- **🔌 HanTV works out how many channels your provider allows, and warns you before refusing one**
...
- **A recording booked across a reboot is repaired when HanTV is next opened**
...
- **Blank poster tiles now show the poster HanTV already found**
...
- **"App not installed" when updating from inside HanTV**
...
- **👶 Kids profiles hide adult content across HanTV**
- **🚀 Start HanTV on a searchable, profile-specific Live TV channel**
...
- **Catch-up you watch inside HanTV now appears in History**
...
- **🌍 HanTV in 24 languages (community PR #108 by @codeVerine)**
