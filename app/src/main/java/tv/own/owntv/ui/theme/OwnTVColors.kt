...
/**
 * HanTV's resolved Material 3 color roles for the current theme + accent. Read as `HanTVTheme.colors`.
 *
...
val LocalHanTVColors = staticCompositionLocalOf { ownTvColors(isDark = true, accent = AccentColor.BLUE) }
