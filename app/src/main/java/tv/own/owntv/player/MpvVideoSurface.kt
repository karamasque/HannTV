...
private class MpvSurfaceView(context: Context, private val player: HanTVPlayer) :
 ...
 *
 * The decoder always fills the surface edge-to-edge (mpv is told, via [HanTVPlayer.setZoomMode], to
...
@Composable
fun MpvVideoSurface(player: HanTVPlayer, modifier: Modifier = Modifier, autoFrameRate: Boolean = true) {
