 ...
 * exactly [HanTVAvatars.COUNT] presets (lightning, sword, tree, car, football, rocket, crown, heart,
...
@Composable
fun HanTVAvatar(avatarId: Int, modifier: Modifier = Modifier, imagePath: String = "") {
    ...
    val i = ((avatarId % HanTVAvatars.COUNT) + HanTVAvatars.COUNT) % HanTVAvatars.COUNT
