...
fun HanTVSpinner(
    ...
    sizeDp: Int = 44,
    color: Color = HanTVTheme.colors.accent,
) {
...
fun LoadingState(
    ...
    Column(
        ...
        Text(
            ...
            color = HanTVTheme.colors.textSecondary,
...
fun ErrorState(
    ...
    Column(
        ...
        if (onRetry != null) {
            ...
            HanTVButton(label = resolvedRetryLabel, onClick = onRetry, icon = HanTVIcon.HISTORY)
        }
    }
}
...
fun EmptyState(
    ...
    Column(
        ...
        HanTVIcon(icon = icon, tint = colors.textSecondary, modifier = Modifier.size(56.dp))
        Spacer(Modifier.height(16.dp))
        Text(
            text = title,
        ...
        if (actionLabel != null && onAction != null) {
            Spacer(Modifier.height(20.dp))
            HanTVButton(label = actionLabel, onClick = onAction, icon = HanTVIcon.MENU)
        }
    }
}
