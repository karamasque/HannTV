...
data class QuickPreviewRow(val icon: HanTVIcon, val label: String, val value: String?)
...
fun quickPreviewRows(settingsVm: SettingsViewModel): List<QuickPreviewRow> {
    ...
    val roots: Map<String, QuickPreviewRow> = mapOf(
        "quick_live_preview" to QuickPreviewRow(
            HanTVIcon.LIVE_TV, stringResource(R.string.settings_quick_live_preview), onOff(livePreview),
        ),
        "quick_preview_sound" to QuickPreviewRow(
            HanTVIcon.AUDIO, stringResource(R.string.settings_quick_preview_sound), onOff(previewAudio),
        ),
        "quick_channel_numbers" to QuickPreviewRow(
            HanTVIcon.LIVE_TV, stringResource(R.string.settings_quick_channel_numbers), onOff(channelNumbers),
        ),
        "quick_hdr" to QuickPreviewRow(
            HanTVIcon.VIDEO, stringResource(R.string.settings_quick_hdr), onOff(hdr),
        ),
        "quick_autoplay" to QuickPreviewRow(
            HanTVIcon.AUTOPLAY_NEXT, stringResource(R.string.settings_quick_autoplay), onOff(autoPlayNext),
        ),
        "quick_check_update" to QuickPreviewRow(
            HanTVIcon.DOWNLOADS, stringResource(R.string.settings_quick_check_update), onOff(updateCheck),
        ),
    )
