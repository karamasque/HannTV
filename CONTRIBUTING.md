# Contributing to HanTV

Thanks for your interest in improving HanTV! Contributions of all sizes are welcome — bug fixes,
features, docs, or ideas.

## Ground rules

- HanTV is a **player only**. Please keep its bring-your-own-source positioning — no bundled channels,
