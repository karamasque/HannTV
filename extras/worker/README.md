# HanTV Cloudflare Workers — self-host reference

HanTV keeps its third-party API keys out of the app by proxying those APIs through small
...
into Cloudflare, add your own API key as a secret, and point HanTV at it.
...
HanTV's built-in default points at the maintainer's own deployment. That deployment runs this
