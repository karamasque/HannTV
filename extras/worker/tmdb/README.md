# HanTV TMDB caching proxy (Cloudflare Worker)
...
calls. This is the same proxy logic HanTV's built-in default metadata server runs.

You can run your **own free copy in about 10 minutes** and point HanTV at it — no programming
...
8. In HanTV on your TV: **Settings → Metadata → Advanced → Custom metadata server URL** →
...
- Images are **not** proxied — HanTV loads poster/backdrop art directly from `image.tmdb.org`,
