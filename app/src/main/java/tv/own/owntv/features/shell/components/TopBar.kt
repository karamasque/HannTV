...
fun TopBar(
    ...
    continueIcon: HanTVIcon = HanTVIcon.PLAY,
...
private fun SearchPill(onClick: () -> Unit, visible: Boolean) {
    ...
    FocusableSurface(
        ...
        Row(Modifier.padding(horizontal = 14.dp, vertical = 7.dp), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            HanTVIcon(icon = HanTVIcon.SEARCH, tint = fg, modifier = Modifier.size(16.dp))
            Text(
...
@Composable
private fun ContinueChip(label: String, icon: HanTVIcon, onClick: () -> Unit, visible: Boolean) {
    val colors = HanTVTheme.colors
    ...
    FocusableSurface(
        ...
        Row(
            ...
            HanTVIcon(icon = icon, tint = fg, modifier = Modifier.size(16.dp))
            Text(
                label,
                style = MaterialTheme.typography.labelLarge,
                color = fg,
...
private fun PlaylistChip(
    ...
    FocusableSurface(
        ...
        Row(
            ...
            HanTVIcon(icon = HanTVIcon.CHEVRON, tint = fg, modifier = Modifier.size(16.dp))
        }
    }
}
